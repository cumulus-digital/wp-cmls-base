 ...
 */
namespace CMLS_Base\Vendors\Composer;

use CMLS_Base\Vendors\Composer\Autoload\ClassLoader;
use CMLS_Base\Vendors\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('CMLS_Base\\Vendors\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
