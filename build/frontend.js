...
/* harmony import */ var _js_frontend_masthead_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_js_frontend_masthead_js__WEBPACK_IMPORTED_MODULE_2__);
...
var $j = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.noConflict();
...
(function ($, window, undefined) {
  ...
  $('html').focusin(function (e) {
    var $context = $('body > header .hamburger, body > header .menu');

    if (!($context.is(e.target) || $context.has(e.target).length) && menuOpenState) {
      menuClose();
    }
  });
})($j, window.self);
