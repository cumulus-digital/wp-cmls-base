...
var $j = jquery__WEBPACK_IMPORTED_MODULE_2___default().noConflict();
...
(function ($, window, undefined) {
  ...
  function windowListeners(events, callback, throttleTime, immediateLaunch) {
    ...
    events.forEach(function (e) {
      ...
      if (e.throttleTime) {
        cb = lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default()(callback, e.throttleTime);
      }

      $(window).on(e.event + '.cmlsBase', cb); //window.addEventListener(e.event, cb);
    });
  ...
  windowListeners([{
    ...
    event: 'load'
  }], detectBodyUnderMasthead, null, true); // Prevent masthead from getting too large or too small
  ...
  function recalculateMastheadHeight() {
    ...
    if (!originalMastheadHeight) {
      originalMastheadHeight = getComputedStyle(document.documentElement).getPropertyValue('--' + window.THEME_PREFIX + '-masthead-height');
    }
  ...
  windowListeners([{
    ...
    event: 'load'
  }], recalculateMastheadHeight, null, true);
...
var $j = jquery__WEBPACK_IMPORTED_MODULE_0___default().noConflict();
...
/* harmony import */ var lodash_throttle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/throttle */ "./node_modules/lodash/throttle.js");
/* harmony import */ var lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_throttle__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _js_frontend_masthead_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/frontend/masthead.js */ "./src/js/frontend/masthead.js");
/* harmony import */ var _js_frontend_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/frontend/menu.js */ "./src/js/frontend/menu.js");
...
addEventListener('resize', lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default()(setVh, 100));
addEventListener('load', function () {
   ...
   */
  var qSearch = location.search.match(/(\??query\-(\d+)\-page)/);

  if (qSearch && !((_location = location) !== null && _location !== void 0 && (_location$hash = _location.hash) !== null && _location$hash !== void 0 && _location$hash.length)) {
    var nav = document.querySelector("[href*=\"".concat(qSearch[0], "\"]"));

    if (nav) {
      var queryBlock = nav.closest('.wp-block-query');
